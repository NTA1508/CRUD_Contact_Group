    ...
    <body>
        <form action="./add_contact" method="post">
            <div class="form-group">
                ...
                <input type="String" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="firstName" required="required">
            </div>
            <div class="form-group">
                <label for="exampleInputPassword1">Last Name</label>
                <input type="String" class="form-control" id="exampleInputPassword1" name="lastName" required="required">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="exampleInputPassword1" name="phoneNumber" required="required">
            </div>
